...
public class EmployerController {
    ...
    public String employerForm(Model model) {
        ...
        return "/admin/realestate/employer/employerForm";
    }
    ...
    public String newUser(@ModelAttribute @Valid Employer employer, BindingResult result ,
        ...
        if(action.equals("CREATE")){
            ...
            return "redirect:/admin/realestate/employers";
        }

        if (action.equals("EDIT")){
            if(result.hasErrors()) {
                model.addAttribute("employer", employer);
                return "/admin/realestate/employerForm";
            }
            Employer editedEmployer = employerService.update(employer);
            return "redirect:/admin/realestate/employer/"+editedEmployer.getId();
        }
    ...
    public String getEmployees(Model model){
        ...
        return "/admin/realestate/employer/employerList";
    }
    ...
    public String getEmployer(@PathVariable("id") Long id,@RequestParam(value = "page",required = false, defaultValue = "1") int page,
        ...
        model.addAttribute("pagenatedUrl" , "/admin/realestate/employer/"+id);
        return "/admin/realestate/employer/show";
    }
    ...
    public String deleteEmployer(@PathVariable("id") Long id , RedirectAttributes redirectAttributes){
        ...
        return "redirect:/admin/realestate/employer";
    }
}
